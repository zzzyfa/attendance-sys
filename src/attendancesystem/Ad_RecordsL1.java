 ...
 * @author User
 */
public class Ad_RecordsL1 extends javax.swing.JFrame {
    ...
    private void butLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butLoadActionPerformed
        ...
        try {
            br = new BufferedReader (new FileReader("Lecturer_Records.txt"));
        } catch (FileNotFoundException ex) {
            Logger.getLogger(Ad_RecordsL1.class.getName()).log(Level.SEVERE, null, ex);
        }
            String read = null;
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ad_RecordsL1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ad_RecordsL1().setVisible(true);
            }
        });
    }
